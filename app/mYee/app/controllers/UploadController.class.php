...
//
        if (($_FILES["file"]["type"] == "image/jpg")||
            ($_FILES["file"]["type"] == "image/png") || ($_FILES["file"]["type"] == "image/gif")||($_FILES["file"]["type"] == "image/jpeg"))
        {
            ...
            else
            {
                ...
                $path=time().".".explode(".",$_FILES["file"]["name"])[1];
                if (file_exists(ROOT_PATH."static/upload/" . $_FILES["file"]["name"]))
                {
...
//                    echo $file;
        ...
        {
            echo  $_FILES["file"]["type"]." isInvalid file";
        }
    }
}