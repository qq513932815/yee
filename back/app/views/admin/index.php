        ...
        <div class="main ">
            ...
            <div class="page-header">
                <div class="pull-left">
                    <ol class="breadcrumb visible-sm visible-md visible-lg">
                        ...
                        <li><a href="index.html"><i class="icon fa fa-user"></i>用户管理</a></li>
                    </ol>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="panel panel-default bk-bg-white">
                        <div class="panel-heading bk-bg-white">
                            <h6><i class="fa fa-table red"></i><span class="break"></span>用户封禁</h6>
                            ...
                            <table class="table table-bordered table-striped datatable-default">
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td class="center hidden-phone">
                                        ...
                                        <a class="btn btn-danger ban" href="javascript:void(0);" userid="<?php echo $v['id']?>"><i class="fa fa-trash-o "></i> 封号</a>
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="panel panel-default bk-bg-white">
                        <div class="panel-heading bk-bg-white">
                            <h6><i class="fa fa-table red"></i><span class="break"></span>用户解封</h6>
                            <div class="panel-actions">
                                <a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
                                <a href="#" class="btn-close"><i class="fa fa-times"></i></a>
                            </div>
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered table-striped datatable-default">
                                ...
                                <tbody>
                                <?php foreach ($userban as $v){ ?>
                                    <tr class="gradeA">
                                        <td><?php echo $v['id']?></td>
                                        <td><?php echo $v['username']?></td>
                                        <td><?php echo $v['phone']?></td>
                                        <td class="center hidden-phone">
                                            <a class="btn btn-success rmban" href="javascript:void(0);" userid="<?php echo $v['id']?>">
                                                <i class="fa fa-reply "> 解封</i>
                                            </a>
                                        </td>
                                    </tr>
                                <?php } ?>
...
<script type="text/javascript">
    $(function () {
        $(".ban").click(function () {
            ...
            layer.confirm('是否封禁该帐号？', {
                title: '封号确认',
                btn: ['确定','取消'] //按钮
            }, function(){
                $.post("<?=LOCAL_ROOT?>User/banUser",{id:userid},function(data){
                    if(data=='1'){
                        layer.msg('封号成功', {icon: 6});
                        setTimeout(function () {
                            location.href='<?= LOCAL_ROOT?>/admin/index';
                        }, 3000);
                    }else{
        ...
        $(".rmban").click(function () {
            var userid = $(this).attr('userid');
            layer.confirm('是否解封该帐号？', {
                title: '解封确认',
                btn: ['确定','取消'] //按钮
            }, function(){
                $.post("<?=LOCAL_ROOT?>User/removeBanUser",{id:userid},function(data){
                    if(data=='1'){
